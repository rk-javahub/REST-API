...
public class RestaurantApiApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		address.setStreetName("Hotgi Road");
		address.setZipcode(411014);

		// Setting Munu entity
		Menu menu = new Menu();
		menu.setMenuName("Thali");
		menu.setPrice(200d);

		Menu menu1 = new Menu();
		menu1.setMenuName("Lassi");
		menu1.setPrice(40d);
		...
		delivery2.setPartnerName("Uber Eats");
		...
		restaurant.setRestaurantName("Kinara Hotel");
		 ...
		 * 
		 * // Using JPQL
		 * menuService.getMenuByRestaurantJPQL("Kinara Hotel").stream().forEach((r) ->
		 * System.out.println(r.getMenuName() + " " + r.getPrice()));
		 * 
		 * // Using SQL
		 * menuService.getMenuByRestaurantSQL("Kinara Hotel").stream().forEach((r) ->
		 * System.out.println(r.getMenuName() + " " + r.getPrice()));
		 */
	}
}
